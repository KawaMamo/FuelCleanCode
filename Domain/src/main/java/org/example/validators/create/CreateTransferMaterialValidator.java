...
public class CreateTransferMaterialValidator {

    private final MaterialRepo materialRepo;
    private final GasStationRepo gasStationRepo;

    public CreateTransferMaterialValidator(MaterialRepo materialRepo, GasStationRepo gasStationRepo) {
        this.materialRepo = materialRepo;
        this.gasStationRepo = gasStationRepo;
    }

    public void validate(CreateTransferMaterialRequest request){
